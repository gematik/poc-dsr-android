...
import de.gematik.dsr.android.LocalActivity

/**
 * BiometricPrompt.kt
 *
 * This file contains the biometric login logic, for example fingerprint,
 * which is used to authenticate yourself after the deviceRegistration
 */
